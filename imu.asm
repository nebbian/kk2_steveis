...
;Board Offset 0 = -45 deg, 1 = 0 deg (normal), 2 = +45 deg

	lds t, BoardOffset
	cpi t, 0
	breq boff4
	rjmp boff1
boff4:							; -45 degrees offset
...
boff1:	cpi t, 1
	brne boff2
	rjmp boff3					; no offset

boff2:							; +45 degrees offset
	ldi yl,0b10110101				; 0.7071 = (2^0.5)/2
...
boff3:	; end of Board Offset code
...
im7:	b16fdiv RxRoll, 4			;Right align to the 16.4 multiply usable bit limit.
	...
	rvbrflagfalse flagSelflevelOn, im9	;SwitchSSPI is true so check if SL switch is off to use Profile 1 SS & PI
